...
!       if(alpha.lt.amax.and.gps.le.gsi)then
          alphal=alpha
...
!  opposite bound comes active
      ...
      ls(pj)=-ls(pj)
      if(ninf.eq.0.or.ninf.ne.n_inf) goto 16
      r(p)=-rp
       goto 20
