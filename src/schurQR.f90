...
!         if(abs(cij-qrij).gt.tol)then
!           print *,'error in C=QR:  i,j =',i,j
!           print *,'cij,qrij =',cij,qrij
!           if(abs(cij-qrij).gt.1.D-6)stop
!         endif
        enddo
      enddo
