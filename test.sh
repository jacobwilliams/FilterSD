...
gfortran -O2 -std=legacy -c ./src/filterSD.f90 ./src/checkd.f90 ./src/glcpd.f90 ./src/l1sold.f90 ./src/shared.f90 ./src/schurQR.f90 ./src/sparseA.f90 ./src/util.f90
ar cr ./build/nlp_sparse.a *.o
rm *.o

# To solve an NLP using a dense matrix data structure, the subroutines in the following files are required
gfortran -O2 -std=legacy -c ./src/filterSD.f90 ./src/checkd.f90 ./src/glcpd.f90 ./src/l1sold.f90 ./src/shared.f90 ./src/denseL.f90 ./src/denseA.f90 ./src/util.f90      
ar cr ./build/nlp_dense.a *.o
rm *.o
